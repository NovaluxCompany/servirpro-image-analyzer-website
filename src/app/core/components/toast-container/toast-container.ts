        ...
        >
          <div [class]="getIconClass(toast.type)" class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 rounded-lg">
            @if (toast.type === 'success') {
              ...
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l6.28 11.184C18.75 15.6 17.79 17 16.28 17H3.72c-1.51 0-2.47-1.4-1.743-2.717L8.257 3.1zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
              </svg>
            } @else {
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
